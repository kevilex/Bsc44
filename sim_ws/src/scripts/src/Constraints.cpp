...
int main(int argc, char** argv)
{
  ...
  moveit_visual_tools::MoveItVisualTools visual_tools("ee_link", rvt::RVIZ_MARKER_TOPIC,
  ...
  target_pose1.header.frame_id = "ee_tool";
  target_pose1.pose.orientation.w = 1.0;
  target_pose1.pose.position.x = 0.28;
  target_pose1.pose.position.y = -0.2;
  target_pose1.pose.position.z = 0.5;
  planning_components->setGoal(target_pose1, "ee_tool");
  ...
  if (plan_solution1)
  {
    ...
    visual_tools.publishAxisLabeled(robot_start_state->getGlobalLinkTransform("ee_tool"), "start_pose");
  ...
  if (plan_solution2)
  {
    ...
    visual_tools.publishText(text_pose, "Start Pose", rvt::WHITE, rvt::XLARGE);
    visual_tools.publishAxisLabeled(robot_state.getGlobalLinkTransform("ee_tool"), "start_pose");
    visual_tools.publishText(text_pose, "Goal Pose", rvt::WHITE, rvt::XLARGE);
    visual_tools.publishAxisLabeled(target_pose1.pose, "target_pose");
  ...
  if (plan_solution4)
  {
    ...
    visual_tools.publishAxisLabeled(robot_state.getGlobalLinkTransform("ee_tool"), "start_pose");
    visual_tools.publishText(text_pose, "Goal Pose", rvt::WHITE, rvt::XLARGE);
    visual_tools.publishAxisLabeled(robot_start_state->getGlobalLinkTransform("ee_tool"), "target_pose");
